export default function About() {
    return (
        <div className="space-y-12 text-md md:text-lg text-muted-foreground pb-4 md:pb-8">
            <p>
                Introducing Quick Convert, the ultimate multimedia conversion powerhouse that empowers you to transform images,
            ...
            <div className="space-y-2">
                ...
                <p>
                    Access Quick Convert from any device with an internet connection. Whether you&apos;re on your computer, tablet,
