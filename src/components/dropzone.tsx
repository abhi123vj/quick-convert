  ...
  return (
    ...
    >
      {({ getRootProps, getInputProps }) => (
        <div
          {...getRootProps()}
          className=" bg-transparent  h-72 lg:h-80 xl:h-96 rounded-3xl shadow-sm border-secondary border-2 border-dashed border-slate-500  cursor-pointer flex items-center justify-center"
        >
          <input {...getInputProps()} />
